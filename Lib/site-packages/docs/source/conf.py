...
latex_documents = [
    (master_doc, 'pyfda.tex', 'pyfda Documentation',
     'Christian Muenker', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyfda', 'pyfda Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyfda', 'pyfda Documentation',
     author, 'pyfda', 'One line description of project.',
     'Miscellaneous'),
]
